...
* **Pendiente:** el nombre del clúster de HiveMQ sigue apareciendo en `docs/ai_logs/AI_LOG_JOSE.md`. Ya no da acceso a nada por sí solo, pero conviene quitarlo. El repositorio tampoco tiene escaneo de secretos propio: habilitar el escaneo y la protección de push de GitHub, o un hook de pre-commit, cerraría el hueco antes de que lo encuentre un tercero. Queda en el [backlog vivo](../PROCESO.md).
